...
**A lição:** quando o encoding está duplamente corrompido, não tente limpar — reconstrua a partir de um sinal que sobreviveu à corrupção.
...
**A lição:** nunca defina faixas por intuição. Deixe a distribuição dos dados definir os cortes.
